...
export function NotificationsCenter() {
  ...
  const normalizeNotification = (n) => {
    // Booking created (nested booking object)
    if (n.type === "booking:new" && n.booking) {
      return {
        ...n,
        bookingId: n.id,
        shopName: n.booking.shopName,
        customerName: n.booking.customerName,
        time: n.booking.time,
        date: n.booking.date,
    ...
    // Booking status updates (already flat)
    return {
      ...n,
      bookingId: n.bookingId ?? n.id,
    };
  };
